...
#    print_peps_fasta = False
    ...
    print_peps_xslx = eval(sys.argv[8])
...
#    detectable_editing_sitse_df = final_peps_df[final_peps_df['editing_sites_inferred']>0]
    ...
    print(str(detectable_sites_num) + ' (out of ' + str(tot_editing_sites) + ' represented by peptides DB) editing sites are detectable by at least one informative peptide (as a part of at least one editing combination)')
    print('Finished  :-)')