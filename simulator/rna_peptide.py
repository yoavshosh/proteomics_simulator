...
class rna_peptide:
    ...
    def __init__(self,sequence,coordinates,extended_sequence,perm_coor, edited_sites, cleavage_sites = [], edge = None, C_terminus = 'no_change',N_terminus = 'no_change', cs_within_pep = 'no_change', sites_in_pep_range = 0, cancelled_cs = False):
        self.seq = sequence
        self.coo = coordinates
        self.extended_seq = extended_sequence
        self.perm_coo = perm_coor
