...
cmd = 'python ' + cleave_script + ' ' + ' '.join([arguments.input_path, arguments.input_fasta, arguments.missed_cleavages, arguments.min_aa_number, arguments.max_mass, arguments.max_sites_per_pep, arguments.print_peps_xlsx])
