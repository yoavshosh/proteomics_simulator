...
def write_mqpar_file(raw_files_path,raw_files,fasta_files,fdr,min_pep_len,max_pep_mass,max_mc,enzymes,quantification,mqpar_name):
    """
...
if __name__ == '__main__':
    ...
    write_mqpar_file(raw_files_path,raw_files,fasta_files,fdr,min_pep_len,max_pep_mass,max_mc, enzymes, quantification, output_name)
...
#    with open('E:/RNA_editing_Large_files/MQ_test/new_lfq.xml', "w") as f:
#        for r in lfq:
#            f.write("f.write('"+r[:-1]+r"\n')"+'\n')
#            
#    with open('E:/RNA_editing_Large_files/MQ_test/new_tmt.xml', "w") as f:
#        for r in tmt:
#            f.write("f.write('"+r[:-1]+r"\n')"+'\n')
#
#    with open('E:/RNA_editing_Large_files/MQ_test/new_itraq.xml', "w") as f:
#        for r in itraq:
#            f.write("f.write('"+r[:-1]+r"\n')"+'\n')            
